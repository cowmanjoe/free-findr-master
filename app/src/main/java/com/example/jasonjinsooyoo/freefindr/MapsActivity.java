        ...
        LocationListener
{
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        User user = UserManager.getOurInstance().getUser(email);
        prefs = user.getCategories();
    ...
    public ArrayList<Marker> markList;

    public void addToEventList(Event e) {
        if (!eventList.contains(e) && prefs.contains(e)) {
            eventList.add(e);
            LatLng ye = new LatLng(e.getLat(),e.getLon());
            MarkerOptions op = new MarkerOptions();
            op.position(ye);
            op.title(e.getName());
            op.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA));

            Marker eMark = mMap.addMarker(op);
            markList.add(eMark);
        }
    }
    ...
    public void onLocationChanged(Location location)
    {
        ...
        // TODO pass to EventFindR

        new RetrieveHttpDataTask().execute();
